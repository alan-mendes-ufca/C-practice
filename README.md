...
- Selection sort
  ...
  - [Definição raza]: Algoritmo de ordenação quue percorre uma lista buscando o menor elemento, ao encontrar esse dígito retorna seu índice para que seja posto início da sequência.
...
- matrizes
  ...
  - **Aritmética de ponteiros em matrizes:**
    ...
    - Existem duas formas dependendo de como foi feita a alocação da matriz.
